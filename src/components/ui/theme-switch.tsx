/*
 * @Author: Diana Tang
 * @Date: 2025-05-21 17:16:23
 * @LastEditors: Diana Tang
 * @Description: some description
 * @FilePath: /vite-react-ts-tailwind-starter/src/components/ui/theme-switch.tsx
 */
    ...
    <DropdownMenu modal={false}>
      <DropdownMenuTrigger asChild>
        <Button variant="ghost" size="icon" className="scale-95 rounded-full">
          ...
          <IconMoon className="size-[1.2rem] absolute rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" />
